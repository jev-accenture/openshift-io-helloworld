...
See the online presentaion with actual Demo at https://jev-accenture.github.io/openshift-io-helloworld/

image::docs/static/images/title.png[]
...
----
$ git clone git@github.com:jev-accenture/openshift-io-helloworld

$ cd openshift-io-helloworld
